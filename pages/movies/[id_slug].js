  ...
  const faqData = [
    {
      ...
      a: `Скачать «${movie.title}» ${movie.year} можно бесплатно через торрент. В таблице выше выберите нужное качество и нажмите на синюю кнопку (для скачивания .torrent файла) или на значок магнита (для мгновенного запуска в клиенте).`
    },
    {
